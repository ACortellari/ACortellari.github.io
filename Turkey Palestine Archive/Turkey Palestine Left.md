...
Sources published in leftist publications will gradually be made available as .csv files in the Sources Database, which will include data on [publication](Sources Database/publications.csv), issues, authors, and articles.
